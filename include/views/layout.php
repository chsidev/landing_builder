...
<aside class="control-panel supra black">
	...
	<div class="default-styles">
		<div class="btn-group" role="group" aria-label="...">
			<button data-id="light" type="button" class="supra-btn btn-default active"><i class="supra icon-sun"></i><span>Светлый</span></button>
			<button data-id="dark" type="button" class="supra-btn btn-default"><i class="supra icon-moon-small"></i><span>Темный</span></button>
		</div>
		<div class="message">
		...
		<button type="button" class="supra-btn apply btn-primary">Применить</button>
	</div>
	<ul class="typography">
		<li><button type="button" class="supra-btn btn-primary apply">Применить</button></li>
	</ul>
	<div class="project-pages">
		<ul>
			<li>
				<i class="supra icon-file-add"></i>
				<span>Добавить новую страницу</span>
			</li>
		</ul>
		<div class="btn-ex-im-d">
			...
			<div type="button" class="supra-btn">
			    <i class="supra icon-hosting"></i>
				<a href="https://www.hostland.ru/?r=13905f59" target="_blank"><center><span style="text-align: center; color: #ffffff;">Бесплатный  Хостинг  на Месяц</span></center></a>
			</div>
